...
int main(){
    ...
    int times = 0,sum = 1000000,error_times = 0,rece_times = 0;
...
//        cout << buf << '\n';
    ...
    cout << "处理速度是" << std::fixed << std::setprecision(3) << (double)rece_times/std::chrono::duration<double>(end - start).count() << "次/秒\n";
